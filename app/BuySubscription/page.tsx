...
const BuySubscription = () => {
  return (
    <section className="w-full h-full flex items-center bg-[#F5F5F5]">
      <div className="w-full flex flex-col items-center justify-between bg-white max-w-7xl mx-auto my-10">
              ...
              <div className="flex items-center justify-center">
                <div className="flex flex-col">
                  ...
                  <p className="text-lg font-semibold p-4">
                    ...
                    امضا کرده است. محصول تیم خلاق آران آسایش آفرینان یعنی کارت
                    تخفیف آران آسایش، حامی اقتصاد خانوار بوده و تلاش شده تا یک
                    مجموعه جامع و یکپارچه از محصولات و خدمات متنوع حوزه‌های
                    سلامت، تفریحی، رفاهی و خماتی در آن گنجانده شود تا خریداران
                    محترم بتوانید با آسودگی خیال و اعتماد کامل از این سامانه که
                    متعلق به خودتان است بهره‌مند شوید.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex gap-4">
          ...
          <SimpleCard
            header={"اشتراک زمرد"}
            text={
              "اگر شما اشتراک الماس کارت تخفیف آران آسایش را دریافت کنید دیگر نیازی به اشتراک‌های دیگر ندارید. فقط کافیست یک کارت الماس را تهیه و از هر چهار نوع خدمات مجموعه‌های تفریحی، درمانی، خدماتی و ورزشی تیم آران آسایش آفرینان استفاده کنید.خرید اشتراک"
            }
            textButton={"خرید اشتراک"}
            Image={""}
          />
