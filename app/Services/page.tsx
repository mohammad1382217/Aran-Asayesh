...
const Services = () => {
  return (
    <>
      ...
      <section className="bg-[#F5F5F5] w-full flex flex-col justify-center py-8">
        <div className="flex container mx-auto px-4 lg:px-8 gap-8">
          <section className="bg-white flex p-12 rounded-2xl w-full sm:flex-col items-center gap-5">
            <div className="container flex flex-row sm:justify-center items-center px-3">
              <div className="w-full flex justify-between">
                <div className="flex justify-between items-center sm:flex-col gap-3">
                  <div className="flex">
                    <div className="w-20 h-20 bg-[#424242] ml-3 rounded-2xl"></div>
                ...
                <div className="flex flex-col items-center justify-center gap-3">
                  <div className="flex">
                    <p className="text-base font-extralight text-[#717171]">
                      امتیاز:
                    </p>
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-base font-semibold text-[#303030] text-justify">
                همه می‌دانیم که خرید خوب و با کیفیت به همراه تخفیف بسیار
                لذت‌بخش‌تر است.{" "}
                <span className="text-[#7F38B7] font-semibold">
                  تخفیف کارت آران آسایش
                </span>{" "}
                با تعداد زیادی از بهترین مجموعه‌ها و برندها از مشاغل گوناگون در
                نقاط مختلف کشور عزیزمان وارد مذاکره شده و قراردادهایی را امضا
                کرده است.
              </p>
            </div>
            <div className="flex">
            ...
            <div className="w-full flex justify-between">
              ...
              <div className="flex gap-4 text-[#7F38B7] sm:justify-center">
                <Typography
                  as="a"
                  href="#"
            ...
            <div className="w-full flex flex-col gap-4">
              <p className="text-[#303030] text-lg font-light">
                <span className="text-[#7F38B7] text-lg font-semibold">
                  آدرس:
                </span>{" "}
                قم، خیابان صفاییه، انتهای کوچه 56، فرعی 13، ساختمان سیما، پلاک
                146، کافه سپید
              </p>
              <p>
                <span className="text-[#7F38B7] text-lg font-semibold">
            ...
            <div className="w-full flex flex-col justify-between mt-4 gap-5">
              ...
              <TextArea
                TextAreaClass={"mt-3 h-44 p-5 border-[#C8C8C8] outline-0"}
                Placeholder={""}
                onChange={() => {}}
              />
              <Button
                ...
                placeholder={undefined}
              >
                <p className="block antialiased text-white max-[425px]:text-sm text-base font-normal transition-colors">
                  ثبت نظر
                </p>
              </Button>
            </div>
