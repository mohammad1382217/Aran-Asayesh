...
const CardComponent: React.FC<CardComponent> = ({ text, img, rate, offer }) => {
  return (
    <Card className="max-w-72 mt-10 mb-10 p-0 card cursor-pointer" imgSrc="">
      <img src={img} alt="" />
      <a href="#">
      ...
      <div className="mb-5 mt-2.5  flex items-center justify-center">
        ...
        <span className="mr-5 text-base font-extralight text-[#717171]">
          از{offer[0]} تا{" "}
          <span className="text-base font-extralight text-[#717171]">
            <span className="text-[#7F38B7] text-2xl font-semibold">
              {offer[1]}
            </span>{" "}
            تخفیف{" "}
          </span>
